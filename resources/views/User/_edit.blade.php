  ...
  <div class="card-body">
    ...
    @csrf
        <div class="mb-3 col-9 form-group">    
            ...
            <input type="text" name="name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$datas1->name}}">
        </div>
        <div class="mb-3 col-9 d-none">
            <label for="exampleInputEmail1" class="form-label"><strong>Nama</strong></label>
            <input type="text" name="id" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$datas1->id}}">
        </div>
        <div class="mb-3 col-9 form-group">
