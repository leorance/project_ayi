                    ...
                    @foreach ($datas1 as $data1)
                        <tr>
                            ...
                            <td class="text-wrap">
                                <div class="row">
                                    <div class="col-2">
                                        <a href="{{ url("users/edit/$data1->id") }}" class="btn"title="edit">
                                    ...
                                    <div class="col-2">
                                        <form action='{{ url("users/delete/$data1->id") }}' method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn" onclick="return confirm('Delete this data?')">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
